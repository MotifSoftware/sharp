 ...
 * @param {boolean} [options.iccTransform] transform ICC profile into sRGB.
 * @returns {Sharp}
 * @throws {Error} Invalid parameters
 */
function withMetadata (options) {
  ...
  if (is.object(options)) {
    ...
    if (is.defined(options.iccTransform)) {
      if (is.bool(options.iccTransform)) {
        this.options.iccTransform = options.iccTransform;
      }
    }
